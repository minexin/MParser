...
for the source-level C++ builtin extension contract. Contract-boundary
milestones v0.77 through v0.90.1 remain beside the current documentation;
earlier implementation history is retained in the
[v0.1-v0.76 milestone archive](docs/history/v0.1-v0.76/README.md).
