...
- [Extending Builtins](extending-builtins.md): current v1.3 builtin source
  contract 1.17 plus archived v1.2 contract 1.1, descriptor rules, registry
...
grouped summaries while preserving the
...
- [v1.9 Relational Table Batch](v1.9.md): stable joins, row maps, grouping,
  shared reduction dispatch, execution control, and five-mode parity.
