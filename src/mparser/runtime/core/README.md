...
| Directory | Ownership |
| --- | --- |
| `value` | `RuntimeValue`, shapes, dense and CSC sparse numeric storage/algorithms, text, Cell/Struct/categorical containers, shared table/timetable storage, datetime/duration values, ranges, and generic array reshape |
