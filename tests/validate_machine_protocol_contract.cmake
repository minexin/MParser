...
foreach(current_document IN ITEMS golden_json emergency_json)
    string(JSON current_minor GET "${${current_document}}" protocol minor)
    if(NOT current_minor EQUAL 2)
        message(FATAL_ERROR "Current machine protocol fixture must declare minor 2")
    endif()
endforeach()
