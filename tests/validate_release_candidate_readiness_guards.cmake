...
function(expect_rejection description tampered_matrix expected_pattern)
    execute_process(
        COMMAND "${MPARSER_CMAKE_COMMAND}"
            ...
            "-DPUBLICATION_EVIDENCE_VALIDATOR=${PUBLICATION_EVIDENCE_VALIDATOR}"
            "-DPUBLICATION_EVIDENCE_ROOT=${PUBLICATION_EVIDENCE_ROOT}"
            "-DEXPECTED_VERSION=${EXPECTED_VERSION}"
            "-DEXPECTED_RELEASE_VERSION=${EXPECTED_RELEASE_VERSION}"
            "-DEXPECTED_PUBLIC_CONTRACT_VERSION=${EXPECTED_PUBLIC_CONTRACT_VERSION}"
            ...
            "-DEXPECTED_RELEASE_ID=${EXPECTED_RELEASE_ID}"
            "-DEXPECTED_RELEASE_PUBLISHED_AT=${EXPECTED_RELEASE_PUBLISHED_AT}"
            "-DEXPECTED_RELEASE_CHECKSUM_SHA256=${EXPECTED_RELEASE_CHECKSUM_SHA256}"
